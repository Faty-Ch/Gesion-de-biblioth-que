...
public class GestionUsager extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        retourButton.setBackground(new Color(0, 102, 255));
        ...
        panRecherch.setBackground(new Color(51, 153, 255));
        ...
        panListeUsager.setBackground(new Color(102, 204, 255));
        ...
        panAjoutUsager.setBackground(new Color(102, 153, 255));
        panAjoutUsager.setBorder(javax.swing.BorderFactory.createTitledBorder("Ajout Usager"));

        panAjoutBas.setBackground(new Color(204, 255, 255));
